...
public class LegTest {
    ...
    public void should_have_three_legs() throws GoogleDirectionsException {
        DirectionsResponse response = directionsSearch.create().from(AddressesHelper.FLORIANOPOLIS).waypoint(AddressesHelper.SAO_JOSE).waypoint(AddressesHelper.PALHOCA)
                .to(AddressesHelper.CAXIAS_DO_SUL).go();
    ...
    // Assert.assertEquals(Integer.valueOf(465582),
    // response.getRoutes().get(0).getLegs().get(0).getDistance().getValue());
    // }
    //
    // @Test
    ...
    // Assert.assertEquals(Integer.valueOf(19463),
    // response.getRoutes().get(0).getLegs().get(0).getDuration().getValue());
    // }
