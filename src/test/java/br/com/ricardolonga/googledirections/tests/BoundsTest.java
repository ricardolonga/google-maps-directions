...
public class BoundsTest {
    ...
    // Assert.assertEquals(Double.valueOf(-27.5846237),
    // response.getRoutes().get(0).getBounds().getNortheast().getLatitude());
    // }
    //
    // @Test
    ...
    // DirectionsResponse response =
    // directionsSearch.create().from(AddressesHelper.FLORIANOPOLIS).to(AddressesHelper.ARARANGUA).go();
    // Assert.assertEquals(Double.valueOf(-48.54945439999999),
    // response.getRoutes().get(0).getBounds().getNortheast().getLongitude());
    // }
    //
    // @Test
    ...
    // DirectionsResponse response =
    // directionsSearch.create().from(AddressesHelper.FLORIANOPOLIS).to(AddressesHelper.ARARANGUA).go();
    // Assert.assertEquals(Double.valueOf(-28.9397731),
    // response.getRoutes().get(0).getBounds().getSouthwest().getLatitude());
    // }
    //
    // @Test
    ...
    // DirectionsResponse response =
    // directionsSearch.create().from(AddressesHelper.FLORIANOPOLIS).to(AddressesHelper.ARARANGUA).go();
    // Assert.assertEquals(Double.valueOf(-49.4977452),
    // response.getRoutes().get(0).getBounds().getSouthwest().getLongitude());
    // }
